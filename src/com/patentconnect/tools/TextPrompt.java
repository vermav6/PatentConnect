// PLEASE IGNORE THIS CLASS. READ BELOW FOR MORE!
/* 
 * This class was created by Rob Camick. All credit goes to him. 
 * The developers of PatentConnect did not write anything in this class.
 * We give full credit to Rob Camick.
 * 
 * This class only affects the GUI portion of PatentConnect. It has
 * nothing to do with the Searching, Sorting, or Parsing aspects of
 * PatentConnect. Thus, this class does not have comments because it
 * should not be graded.
 * 
 * This class makes the GUI TextFields more intuitive and pretty by
 * simulating Ghost text that disappears when the field is focused on
 * and reappeared and focus is shifted elsewhere. 
 * 
 * You can read more about this class on Rob Camick's website:
 * https://tips4java.wordpress.com/2009/11/29/text-prompt/
 * 
 * Once again, we give full credit to Rob Camick for creating
 * this class and enhancing the abilities of Java Swing.
 * 
